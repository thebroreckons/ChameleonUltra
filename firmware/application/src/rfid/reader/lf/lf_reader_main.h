...
uint8_t write_ioprox_to_t55xx(uint8_t *data, uint8_t *newkey, uint8_t *old_keys, uint8_t old_key_count);
uint8_t write_jablotron_to_t55xx(uint8_t *data, uint8_t *newkey, uint8_t *old_keys, uint8_t old_key_count);
uint8_t write_paradox_to_t55xx(uint8_t *data, uint8_t *newkey, uint8_t *old_keys, uint8_t old_key_count);
uint8_t write_fdxb_to_t55xx(uint8_t *data, uint8_t *newkey, uint8_t *old_keys, uint8_t old_key_count);
uint8_t write_indala_to_t55xx(uint8_t *data, bool is_224, uint8_t *newkey, uint8_t *old_keys, uint8_t old_key_count);
uint8_t scan_pac(uint8_t *data);
uint8_t write_pac_to_t55xx(uint8_t *data, uint8_t *newkey, uint8_t *old_keys, uint8_t old_key_count);
